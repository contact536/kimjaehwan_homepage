...
export function searchResearch(question:string, rows?:Awaited<ReturnType<typeof researchRows>>){
 ...
 const synonyms:Record<string,string[]>= {'학력':['mba','박사','학위'],'경력':['대표','연구원'],'연구':['cloa','taxia','kortaxarena'],'세무':['tax','세무'],'이메일':['연락'],'학교':['mba','박사'],'김재환':['대표']};
