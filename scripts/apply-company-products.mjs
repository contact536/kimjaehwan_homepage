...
const products = [
  ...
  { name: 'Hoban AI Voice', category: 'governance', categoryLabel: 'GOVERNANCE', description: '회의 녹음·전사·화자 분리 기반 지식 워크스페이스', result: '안전한 온프레미스 연결' },
