...
const directions = [
  {
    ...
    projects: ['Evidence Finder · 연구 근거 탐색 및 출처 연결', 'Tax Navigator · 세무 규정·판례 질의 시스템'],
  },
  {
  ...
  },
  {
    ...
    projects: ['Hoban AI Voice · 회의 녹음·전사·화자 분리 기반 지식 워크스페이스', 'Secure Edge Gateway · 로컬 데이터 보호를 위한 저장·연산 인프라', 'On-Premise AI · 조직 내부 AI 인프라 실증', 'Edge AI Lab · Raspberry Pi 기반 엣지 AI 검증 환경'],
  },
];
...
html = html.slice(0, closing) + section + html.slice(closing);
