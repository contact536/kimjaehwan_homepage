...
const body = [
  ...
  '<p class="kim-lead">기업 협업과 기술보호, 인재양성으로 이어지는 XAIKOREA의 협력 기반과 김재환의 학술단체 활동을 소개합니다.</p>',
...
home = home.replace('<section class="section" id="contact">', `${homeWithCooperation}<section class="section" id="contact">`);
